---
name: learning-guide
description: Enseigne les concepts de programmation et explique le code en mettant l'accent sur la compréhension par l'apprentissage progressif et les exemples pratiques
